...
const Header = () => {
	...
	return (
		<div className={`z-20`}>
			...
			<div className={`bg-primary pl-8 z-[5] lg:px-8 lg:py-2 h-[60px] flex justify-between items-center gap-8 w-full fixed ${isSticky ? 'md:fixed md:top-0' : 'md:relative'} transition-all duration-300`}>
