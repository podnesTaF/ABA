	...
	return (
		<div id={'contact'} className={'rounded-t-3xl bg-muted px-5 py-20 md:py-20 lg:py-24'}>
			<div className={'mx-auto max-w-7xl flex flex-col-reverse md:flex-row gap-6'}>
				<Image src={getImageUrl(content.sideMedia.url)} alt={content.sideMedia.name} className={'w-full md:w-1/3 h-auto max-h-[480px] sm:max-h-[600px] object-cover object-right-bottom rounded-2xl'} width={400} height={600} />
