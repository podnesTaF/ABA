		...
		<div id={'history'} className={'relative mt-[200px] md:mt-[400px]'}>
			...
			<div className={'bg-gray-200 w-full rounded-3xl relative z-10'}>
				<Section className={'gap-3'}>
					<h3 className={'text-base sm:text-lg font-bold'}>The origins of Ace Battle</h3>
					{content.description &&
						<ParseContent text={content.description} mainTitleClassName={'text-2xl md:text-3xl xl:text-4xl font-bold mb-4 md:mb-6 uppercase'} secondaryTitleClassName={'text-base md:text-lg'} />
 					}
				</Section>
			</div>
		</div>
