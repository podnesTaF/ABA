	...
	return (
		<div className={'flex flex-col lg:flex-row gap-5'}>
			...
			<div className={cn('flex-1', containerClass)}>
				{content.description && (
					<ParseContent text={content.description} mainTitleClassName={'font-bold text-2xl my-2'} secondaryTitleClassName={cn('text-xl font-medium ulist-base',secondaryTitleClassName)} />
				)}
				{children}
			</div>
		</div>
